...
|originalFile |Property<String> |1.x |"" |Yes |Filename for the original version of the specification.

|newFile |Property<String> |1.x |"" |Yes |Filename for the original version of the specification.

|originalFile |RegularFileProperty |2.x |"" |Yes |File for the original version of the specification.

|newFile |RegularFileProperty |2.x |"" |Yes |File for the original version of the specification.
